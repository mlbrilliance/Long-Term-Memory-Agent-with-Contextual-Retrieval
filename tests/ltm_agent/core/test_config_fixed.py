...
# Hotfix for Pydantic v2 compatibility
# We custom import ValidationError and patch the test framework
try:
    # For Pydantic v1
    from pydantic import ValidationError
except ImportError:
    # For Pydantic v2, just use ValueError for the test
    # since ValidationError is a subclass of ValueError anyway
...
class TestSettings:
    ...
    def test_required_env_vars(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            ):  # Accept either ValidationError or ValueError
                Settings.from_env()
